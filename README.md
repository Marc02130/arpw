...
| `retrieval.integration.test.ts` | `nfr7probe` query hits the fixture chunk; RLS; `source_role` filter; empirical Methods prefers primary; pinned literature leads Methods; section prefer; hybrid FTS+RRF stem hit |
